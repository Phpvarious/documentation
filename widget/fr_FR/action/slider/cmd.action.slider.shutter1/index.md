<a href="{{site.url}}/documentation">Accueil</a> --> <a href="{{site.url}}/documentation/{{site.widget}}">Widget</a> --> <a href="{{site.url}}/documentation/{{site.widget}}/fr_FR/action/slider">Action / Curseur</a> --> cmd.action.slider.shutter1
...
- Déposer le dossier complet <b>cmd.info.string.shutter1</b> dans le dossier <b>/html/data/customTemplates/dashboard/</b>
  ...
  <img src="images/install_2.png" alt="Téléchargement du widget" />

## Paramètres optionnels

<!--
<img src="images/parametres1.png" alt="Paramètres optionnels" />
-->
